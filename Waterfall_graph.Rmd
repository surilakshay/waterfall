...
```
##Create a waterfall graph for the given input.
waterfall_graph(metric,spend1,spend2)- For each metric the function calculates Spend2-Spend1. If the difference is positive the bar is Green else Red.
The inputs to the function must be data tables else the function would throw an error.
```{r}
waterfall_graph(metric,spend1,spend2)
